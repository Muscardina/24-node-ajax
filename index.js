...
//La exponensiasion
const exponenciacion = (req, res) => {
  var exponente1 = Number(req.query.parametro1);
  var exponente2 = Number(req.query.parametro2);
  var resultado5 = exponente1 ** exponente2;

  res.send(`EXPON: ${exponente1} ** ${exponente2} = ${resultado5}`);
};

calculadoraBackend.get("/exponenciacion", exponenciacion);
